...
public final class ActivityThread {
    ...
    public static void main(String[] args) {
        ...
        ActivityThread thread = new ActivityThread();//这个main函数是static的，所以，这里需要new
        thread.attach(false);//Activity是有界面显示的，这个函数将与WindowManagerService建立联系。
