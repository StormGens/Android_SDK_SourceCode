...
public class RecyclerView extends ViewGroup {
     ...
     * 【汉】一个ViewHolder描述了在RecyclerView中某一项的项目视图和元数据，
     *
     *
    ...
    public static abstract class ViewHolder {
        ...
        /**
         * 通知recycler该item是否可以被回收掉，被设置为不可回收的views，将不会被其他items复用，直到
         * 他稍后又被设置为true。对setIsRecyclable()的调用一般都是成对出现的。（一个setIsRecyclabe(false)
         * 后面需要一直有setIsRecyclable(true)相对应）。
         *
         ...
         * is true.
         * @param recyclable 该item是不是可以被recycled，默认值为true
         */
         ...
         * @return 如果该item可以被回收，那么返回true，否则返回false
         */
