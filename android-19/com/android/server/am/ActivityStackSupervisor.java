...
public final class ActivityStackSupervisor {
    ...
    final int startActivityMayWait(IApplicationThread caller, int callingUid,
        ...
        synchronized (mService) {
            ...
            if (aInfo != null &&
                ...
                if (aInfo.processName.equals(aInfo.applicationInfo.packageName)) {//如果是该APP的主进程
                    if (mService.mHeavyWeightProcess != null &&
                            (mService.mHeavyWeightProcess.info.uid != aInfo.applicationInfo.uid ||
                            !mService.mHeavyWeightProcess.processName.equals(aInfo.processName))) {//如果还有该APP之外的其他重请求操作
    ...
    final int startActivityLocked(IApplicationThread caller,
        ...
        ActivityRecord sourceRecord = null;//记录Launcher的Activity的ActivityRecord。  
    ...
    final int startActivityUncheckedLocked(ActivityRecord r,
        ...
        //如果我们不知道Caller是谁，那么我们把当前栈顶的Activity当做Caller  
        ...
        if (r.resultTo != null && (launchFlags&Intent.FLAG_ACTIVITY_NEW_TASK) != 0) {
            //不管是因为什么原因，这个Activity想要在新的task中启动，还想要resultTo结果，这
            //肯定是调用者喝醉了！那么，我们直接无视他，不给他返回结果了
