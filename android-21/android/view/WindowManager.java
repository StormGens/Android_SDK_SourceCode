 ...
 * apps和window Manager 沟通的接口
 * <p>使用Context.getSystemService(Context.WINDOW_SERVICE)来获得一个实例。</>
 * <p>每一个window Manager实例被绑定到一个独有的Display上，如果想要获得一个绑定到其他display上的window Manager
 * 使用 {@link Context#createDisplayContext}来获得一个那个display的context。
 * 
 * * * *
 * <p>
