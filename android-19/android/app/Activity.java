...
public class Activity extends ContextThemeWrapper
    ...
    /*Binder代理对象，指向了ActivityManagerService中的一个类型为ActivityRecord的Binder本地对象。
    每一个已经启动的Activity都在ActivityManagerService中有一个对应的ActivityRecord对象，用来维护Activity
    组件的运行状态以及信息*/
    ...
    /*mMainThread 用来描述一个应用程序进程，系统没启动一应用程序进程时，都会在这个近程里面加载一个ActivityThread实例，
    *并且会把它保存到每一个在该进程中启动的Activity的父类的成员变量mMainThread中（也就是这里）（俗称UI主线程）。
    */
     ...
     * specified.相当于{@link #startActivity(Intent, Bundle)} ,第二个参数为空，没有特殊的配置
     *
     * @param intent The intent to start.
     *
     * @throws android.content.ActivityNotFoundException
